const schoolData = {
    info: {
        ...
        concept: "とりの丘学園は、初等部から大学部まで一貫した教育を行う学園です。制服の着用は自由。自分自身の『翼（個性）』をどう表現するかも、教育の一環と考えています。",
        uniforms: [
            { stage: "初等部", style: "紺色のセーラー服", img: "uniform-e.png" },
            { stage: "中等部", style: "学ラン / 黒いセーラー服", img: "uniform-m.png" },
            { stage: "高等部", style: "ブレザー / クリーム色のセーター / 赤リボン or ネクタイ / 赤チェックのスカート or 紺ズボン", img: "uniform-h.png" }
        ]
    },
    characters: [
        {
        ...
        { id: "kuu", name: "くうちゃん", class: "1-3", motif: "カラス", type: "INTJ / ILI / 5w4", description: "不器用な陰キャ（自称）。のりおみの最大の理解者。", img: "kuu.png", quote: "……勝手にいがみ合ってればいいじゃん。" },
        { id: "satsuki", name: "さつき", class: "3-2", motif: "生徒会長", type: "INTJ / LII / 5w6", img: "satsuki.png", quote: "秩序こそが、学園を美しく保つ鍵です。" },
        // ... 他のキャラもここに追加
    ],
    terms: [
